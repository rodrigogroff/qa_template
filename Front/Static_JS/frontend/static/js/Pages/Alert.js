        ...
        return `
            ...
            <div align='center'>
                <div style='width:900px'>
                    ...
                    <div align='left'>
                        <button class='btn btn-shadow btn-xs btn-danger mr-3 mb-5' id='open_modal_danger'>Danger</button>
                        <button class='btn btn-shadow btn-xs btn-success mr-3 mb-5' id='open_modal_success'>Success</button>
                        <button class='btn btn-shadow btn-xs btn-warning mr-3 mb-5' id='open_modal_warning'>Warning</button>
                        <button class='btn btn-shadow btn-xs btn-info mr-3 mb-5' id='open_modal_info'>Info</button>
                    </table>
